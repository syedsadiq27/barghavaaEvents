...
<div id='crmWebToEntityForm' class='zcwf_lblLeft crmWebToEntityForm' style='background-color: white;color: black;max-width: 600px;'>
    ...
    <form action='https://crm.zoho.com/crm/WebToLeadForm' name=WebToLeads5095980000000341199 method='POST' onSubmit='javascript:document.charset="UTF-8"; return checkMandatory5095980000000341199()' accept-charset='UTF-8'>
        <input type='text' style='display:none;' name='xnQsjsdp' value='7730ab9a2e7a202a391ddcc39a7c7e58b0a0b1cc7829a184e09e0eaef7dc0b71'></input>
        <input type='hidden' name='zc_gad' id='zc_gad' value=''></input>
        <input type='text' style='display:none;' name='xmIwtLD' value='c2b94e7e88cd6b6f9a3104e76cf366aa3d962e6b689239c396a0b21b17463cfa'></input>
        <input type='text' style='display:none;' name='actionType' value='TGVhZHM='></input>
        <input type='text' style='display:none;' name='returnURL' value='https&#x3a;&#x2f;&#x2f;bargavaaevents.com&#x2f;contact-us.php'> </input>
        ...
        <script>
            function validateEmail5095980000000341199() {
                var form = document.forms['WebToLeads5095980000000341199'];
            ...
            function checkMandatory5095980000000341199() {
                var mndFileds = new Array('Last Name', 'Email', 'Mobile');
                var fldLangVal = new Array('Name', 'Email', 'Mobile');
                for (i = 0; i < mndFileds.length; i++) {
                    var fieldObj = document.forms['WebToLeads5095980000000341199'][mndFileds[i]];
                    if (fieldObj) {
                ...
                if (!validateEmail5095980000000341199()) {
                    return false;
                }
                document.querySelector('.crmWebToEntityForm .formsubmit').setAttribute('disabled', true);
            }

            function tooltipShow5095980000000341199(el) {
